...
function audit() {
  ...
  console.log(
    `Scan complete. Found ${auditResults.length} image references across ${htmlFiles.length} files.`,
  );
  ...
  fs.writeFileSync(
    path.join(baseDir, "full_image_audit.json"),
