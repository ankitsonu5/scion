...
files.forEach((file) => {
  ...
  const urlRegex =
    /https?:\/\/[^"'\s()<>]+(?:unsplash\.com|placehold\.co|wikimedia\.org)[^"'\s()<>!*]*/gi;
  ...
  content = content.replace(urlRegex, (url) => {
    ...
    if (fileNameLower.includes("brands-overview"))
      replacement = "Our Brands - BG 2.jpg";
  ...
  if (
    ...
    (content.includes("unsplash") || content.includes("placehold"))
  ) {
