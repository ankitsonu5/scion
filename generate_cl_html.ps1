$baseDir = "C:\Users\idkth\Documents\scion\assets\images\brands\cl"
$folders = @{
    "CL 20 ml gift set" = "gift-set"
    "CL D" = "dlx"
    "CL Oriental" = "oriental"
    "CL Prive'" = "prive"
    "CL Std" = "standard"
}
...
foreach ($key in $folders.Keys) {
    ...
    if (Test-Path $path) {
        ...
        foreach ($file in $files) {
            ...
            $imgPath = "assets/images/brands/cl/$encodedKey/$encodedImgName"
...
Set-Content -Path "C:\Users\idkth\Documents\scion\cl_products_raw.html" -Value $html
Write-Host "Generated cl_products_raw.html"
