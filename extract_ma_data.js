...
const sheetName = workbook.SheetNames.includes("Sheet1 (2)")
  ? "Sheet1 (2)"
...
fs.writeFileSync(
  "C:\\Users\\idkth\\Documents\\scion\\ma_extracted_data.json",
  JSON.stringify(maData, null, 2),
);
console.log(
  `Extraction complete. Found data for ${Object.keys(maData).length} products.`,
);
